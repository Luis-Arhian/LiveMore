    ...
    <div class="card-body">
            {!!Form::open(['route' => 'admin.categories.store', 'files' => 'true']) !!}
                ...
                <div class="form-group">
                    ...
                    @error('slug')
                        <span class="text-danger"> El slug seleccionado ya existe. </span>
                    @enderror
                </div>
                    ...
                    <div class="col">
                        <div class="imageContainer mb-5">
                            @isset($categoria->image)
                                <img id="image" src="http://localhost/livemore/storage/app/{{$categoria->images->url}}" alt="Imagen por defecto">
                            @else
